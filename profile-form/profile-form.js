...
const nextInterest = document.querySelector(".next-interest")
...
nextInterest.addEventListener("click", (e) => {
    e.preventDefault()
    sectionInterest.style.display = "none"
    sectionSocial.style.display = "flex"
})
